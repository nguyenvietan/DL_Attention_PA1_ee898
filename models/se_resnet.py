...
__all__ = ['SE_ResNet', 'se_resnet34', 'se_resnet50']
...
class SE_Block(nn.Module):
    ...
    def __init__(self, inplanes):
        ...
        self.se_avg_Gpool = nn.AdaptiveAvgPool2d(1)
        self.se_conv1 = conv1x1(inplanes, inplanes/self.r)
        self.se_relu = nn.ReLU(inplace=True)
        self.se_conv2 = conv1x1(inplanes/self.r, inplanes)
        self.se_sigmoid = nn.Sigmoid()

    def forward(self, x):
        out = self.se_avg_Gpool(x)
